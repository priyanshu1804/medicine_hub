  ...
  return <div className=" h-fit">
    <div className="w-full h-[15rem]">
      ...
      <div className="flex items-center justify-center">
        <div class="w-11/12 flex rounded-md border-2 border-blue-500 overflow-hidden max-w-md mx-auto font-[sans-serif]">
        <input type="email" placeholder="Search Medicine..."
          class="w-full outline-none bg-white text-gray-600 text-sm px-4 py-3" onChange={(e)=>setFilter(e.target.value)}/>
